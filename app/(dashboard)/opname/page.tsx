      ...
      <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
            ...
            Belum familiar? Pelajari langkah-langkahnya di <Link href="/panduan#opname" scroll={false} className="underline font-medium hover:text-amber-900 dark:hover:text-amber-200">Panduan Stok Opname</Link>.
          </p>
        </div>
      </div>
