...
Dua function di `migrations/0102_schema_functions.sql` — `fn_save_bundle_recipe` dan `fn_handle_new_user` — dijalankan dengan `SECURITY DEFINER`. Artinya function itu berjalan dengan hak akses milik pembuatnya, bukan hak akses user yang memanggilnya.
